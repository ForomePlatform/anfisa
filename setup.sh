...
echo "python -m app.storage -c $PROJECT_HOME/anfisa-docker.json -m create -f -k ws -s PGP3140.json.gz PGP3140"
python -m app.storage -c $PROJECT_HOME/anfisa-docker.json -m create -f -k ws -s PGP3140.json.gz PGP3140
