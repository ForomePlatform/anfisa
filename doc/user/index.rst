...
* A set of standard and custom rare variant callers
  identifying extremely rare and unknown variants in a pedigree-aware way;
* The downstream annotation pipeline programmatically accessing a wide range of information
  related to functional analysis from relevant scientific and clinical databases
  (population genetics, clinical information, epigenetics)
...
Detailed description of AnFiSa anf Forome platform from scientific point of view can be found
in paper:
...
* Providing regular updates of genomics databases without posing challenges
  for reproducible and traceable automated genetic diagnostics tools
...
* Has been developed to invite and accept contributions from clinicians,
  researchers and professional software developers
