...
class HOT_SETUP:
    ...
    FUNCTIONS = [
        ...
        RuleFuncH("SEQaBOO_Hearing_Loss_v_03",
            "seq_a_boo_hearing_loss_3", seq_a_boo_hearing_loss_v3_evalRec),
        RuleFuncH("SEQaBOO_Hearing_Loss_v_02",
            "seq_a_boo_hearing_loss_2", seq_a_boo_hearing_loss_v2_evalRec),
        RuleFuncH("SEQaBOO_Hearing_Loss_v_01",
            "seq_a_boo_hearing_loss", seq_a_boo_hearing_loss_v1_evalRec),
